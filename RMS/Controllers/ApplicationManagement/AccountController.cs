...
namespace RMS.Controllers.ApplicationManagement
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public ActionResult CreateRole(Role role)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Impossible", "The Role 'Supperuser' already exists!");
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                //if (model.Password == "password" || model.Password == "administrator")
                //{
                    ModelState.AddModelError("", "Password is weak!");
                //}
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                //if (model.Password == "password" || model.Password == "administrator" || model.Password == model.UserName)
                //{
                    ModelState.AddModelError("", "Password is weak!");
                //}
